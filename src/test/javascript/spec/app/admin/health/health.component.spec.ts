...
import { IfrisHealthCheckComponent } from 'app/admin/health/health.component';
import { IfrisHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('IfrisHealthCheckComponent', () => {
        let comp: IfrisHealthCheckComponent;
        let fixture: ComponentFixture<IfrisHealthCheckComponent>;
        let service: IfrisHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [JHipsterRegistryTestModule],
                declarations: [IfrisHealthCheckComponent]
            })
                .overrideTemplate(IfrisHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(IfrisHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(IfrisHealthService);
        });
