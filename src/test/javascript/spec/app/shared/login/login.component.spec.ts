...
import { IfrisLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: IfrisLoginModalComponent;
        let fixture: ComponentFixture<IfrisLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [IfrisLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(IfrisLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(IfrisLoginModalComponent);
